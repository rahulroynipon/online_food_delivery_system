...
// In production / serverless environments, use the writable /tmp directory
...
// Configure Storage Engine (local disk storage in dev, or temp /tmp storage in prod before Cloudinary)
  ...
  for (const file of filesToUpload) {
    if (file && file.path && fs.existsSync(file.path)) {
      try {
        ...
        // Delete the local temporary file from /tmp
