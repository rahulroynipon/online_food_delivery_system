            ...
            {restaurants.map((res) => (
              <Link key={res.id} to={`/restaurant/${res.slug}`} className="group">
                <Card className="overflow-hidden border border-border/40 hover:border-primary/30 bg-card/65 group-hover:bg-card transition-all duration-300 shadow-2xs group-hover:shadow-xs rounded-2xl relative h-full flex flex-col justify-between">
                  ...
                  {/* Banner */}
                  <div className="h-24 bg-gradient-to-tr from-primary/10 via-primary/5 to-transparent relative border-b border-border/10 flex items-center justify-center">
                    <Utensils className="h-10 w-10 text-primary/10 group-hover:scale-110 group-hover:rotate-6 transition-transform duration-300" />
