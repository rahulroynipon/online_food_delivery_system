...
export const badgeVariants = cva(
  'inline-flex items-center justify-center font-medium rounded-full border transition-all duration-200 leading-none shrink-0 relative max-w-full overflow-hidden text-ellipsis',
  {
    variants: {
      variant: {
      ...
      size: {
        xs: 'text-[10px] px-2 py-0.5 min-h-[20px] min-w-[18px]',
        sm: 'text-xs px-2.5 py-0.5 min-h-[22px] min-w-[20px]',
        md: 'text-xs px-3 py-1 min-h-[26px] min-w-[22px]',
        lg: 'text-sm px-3.5 py-1 min-h-[30px] min-w-[24px]',
